...
use rppal::gpio::{Gpio, Level}; //Can change based on requirements
...
fn main() {
    ...
    a_last_state = output_a.read();

    loop {
        a_state = output_a.read(); // Reads the "current" state of OUTPUT_A
